...
- (void)viewDidLoad {
    ...
    [self.psddDic setObject:@"" forKey:@"sid"];
...
-(void)setTopLabel
{
    ...
    label.backgroundColor = GlobalBackgroundColor;
...
- (void)setBackLeftButton:(NSString *)imageName
{
    ...
    self.BackleftButton.tintColor = UIColorWhite;
...
- (void)setLeftButton:(NSString *)imageName title:(NSString *)name;
{
    ...
    image = [image imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    imageview.tintColor = UIColorWhite;
    imageview.image = image;
    [leftButton addSubview:imageview];
    [self.image addSubview:leftButton];
    leftButton.tintColor = UIColorWhite;
