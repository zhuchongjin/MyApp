...
#import "NoDataTableviewVC.h"

@interface NoDataTableviewVC ()
@property (nonatomic,strong)UITableView *tableView;

@end

@implementation NoDataTableviewVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
     [self setTitleName:@"tableview空数据提示"];
    // 直接pod导入 即可使用    pod 'JHNoDataEmptyView'
