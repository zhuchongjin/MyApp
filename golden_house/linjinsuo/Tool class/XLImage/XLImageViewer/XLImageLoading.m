...
{
    CGFloat labWidth = 35.0f;
    _loadingLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, labWidth, labWidth)];
    ...
    float centerX = labWidth/2.0;
    float centerY = labWidth/2.0;
    //半径
    float radius = (labWidth - lineWidth)/2.0f;
    //创建贝塞尔路径
