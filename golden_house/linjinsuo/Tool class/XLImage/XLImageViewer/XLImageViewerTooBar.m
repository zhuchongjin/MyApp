...
-(void)buildUI{
    //显示分页的label
    CGFloat labWidth = 50.0f;
    CGFloat labHeignt = 28.0f;
    CGFloat viewMargin = 5.0f;
    _pageLabel = [[UILabel alloc] initWithFrame:CGRectMake(viewMargin, 0, labWidth, labHeignt)];
    _pageLabel.center = CGPointMake(_pageLabel.center.x, labHeignt/2.0f);
    ...
    _saveButton.frame = CGRectMake(self.bounds.size.width - labWidth - viewMargin, 0, labWidth, labHeignt);
    _saveButton.center = CGPointMake(_saveButton.center.x, labHeignt/2.0f);
