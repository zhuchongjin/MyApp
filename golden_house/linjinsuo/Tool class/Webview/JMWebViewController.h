...
@interface JMWebViewController :BaseViewController

@property (nonatomic, strong)NSURL *url;
@property (nonatomic, strong)NSString *name;
@property (nonatomic, strong)UIColor *tintColor;

@property (nonatomic, readonly)JMWebView *webView;
...
@property (nonatomic, assign ,getter= isHiddenTitleView)BOOL hiddenTitleView;
...
-(void)XiugaiBackyanse:(NSString *)status;
