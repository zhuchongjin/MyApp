...
typedef NS_ENUM(NSInteger, JMWebViewNavigationType) {
    JMWebViewNavigationTypeLinkClicked,
    JMWebViewNavigationTypeFormSubmitted,
    JMWebViewNavigationTypeBackForward,
    JMWebViewNavigationTypeReload,
    JMWebViewNavigationTypeFormResubmitted,
    JMWebViewNavigationTypeOther
};
@protocol JMWebViewDelegate <NSObject>
@optional
...
@end
@interface JMWebView : UIView

/*! @abstract The web delegate. */
@property ( nonatomic, weak) id <JMWebViewDelegate> delegate;
