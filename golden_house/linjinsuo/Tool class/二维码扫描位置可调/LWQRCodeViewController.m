...
#define ScanY 100          //扫描区域y
#define ScanWidth 250       //扫描区域宽度
#define ScanHeight 100      //扫描区域高度
...
- (void)UI
{
    ...
    //扫描区域外的背景
    LWQRCodeBackgroundView *qrcodeBackgroundView = [[LWQRCodeBackgroundView alloc] initWithFrame:CGRectMake(0, 0, LWSCREEN_WIDTH,LWSCREENH_HEIGHT)];
