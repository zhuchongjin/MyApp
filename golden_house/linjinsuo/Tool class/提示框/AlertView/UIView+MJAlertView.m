...
//    NSInteger notifierHeight = MAX(CGRectGetHeight(notifierRect) + 2*xPadding, kLabelHeight);
    if(!shouldDismiss) {
    ...
    if(notifierView) {
        ...
        [self updateNotifierWithAnimation:notifierView withText:text completion:^(BOOL finished) {
           ...
           textLabel.frame = CGRectMake(xPadding, 0.0, notifierWidth - 2*xPadding, 45);
        ...
        notifierView.backgroundColor = RGB(210, 210, 210);
